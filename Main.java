public class Main {
    public static void main(String[] args) {
        ...
        if (opcion == Opcion.SUMA) {
            System.out.println("Operación selecionada: Suma");
        }
        switch (opcion) {
            case SUMA:
            ...
            case RESTA:
                ...
                break;
            case MUTIPLICACION:
                System.out.println("Operación seleccionada: Multiplicacion");
                break;
            case DIVISION:
                System.out.println("Operación seleccionada: Division");
                break;
        }
    }
}
